...
export default function QRScanner({ eventId, onTicketScanned }: QRScannerProps) {
    ...
    try {
      ...
      const mockTicket: Ticket = {
        ...
        user: {
          ...
          role: 'student',
          interests: [],
          notification_preferences: { email: true, whatsapp: false, telegram: false },
          created_at: '',
          updated_at: ''
        },
        event: {
                ...
                <div className="bg-white rounded-lg p-4 text-left">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-mono text-sm">{scanResult.ticket.ticket_id}</span>
                    </div>
                    ...
                    {scanResult.qrData?.type === 'team' && scanResult.ticket.team_name && (
                      <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant={scanResult.qrData?.type === 'team' ? 'default' : 'secondary'}>
                    ...
                    {scanResult.ticket.checked_in_at && (
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm">
                          {new Date(scanResult.ticket.checked_in_at).toLocaleString()}
                        </span>
                      </div>
                    )}
                  </div>
