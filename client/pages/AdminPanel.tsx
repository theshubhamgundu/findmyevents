...
export default function AdminPanel() {
    ...
    try {
      ...
      if (organizer) {
        await createNotification({
          ...
          message:
            "Congratulations! Your organizer application has been approved. You can now create and publish events.",
  ...
  const publishedEvents = allEvents.filter(
    (e) => e.event_status === "published",
  ).length;
  const totalRegistrations = allEvents.reduce(
    (sum, event) => sum + event.current_participants,
    0,
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage organizer approvals, event moderation, and platform
              oversight
            </p>
          </div>
                        ...
                        >
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600 space-y-1">
                                ...
                                {organizer.social_links?.linkedin && (
                                  <p>
                                    LinkedIn: {organizer.social_links.linkedin}
                                  </p>
                                )}
                              </div>
                            </div>
                          ...
                          <div className="mb-4">
                            ...
                            <div className="flex space-x-2">
                              {organizer.verification_documents.map(
                                (doc, index) => (
                                  <Button
                                    key={index}
                                    variant="outline"
                          ...
                          <div className="flex space-x-3">
                            <Button
                              onClick={() =>
                                handleApproveOrganizer(organizer.id)
                              }
                            ...
                            {selectedItem === `organizer-${organizer.id}` ? (
                              <div className="flex space-x-2">
                                <Button
                                  onClick={() =>
                                    handleRejectOrganizer(organizer.id)
                                  }
                                  variant="destructive"
                              ...
                              <Button
                                onClick={() =>
                                  setSelectedItem(`organizer-${organizer.id}`)
                                }
                                variant="destructive"
                              >
                        ...
                        <div key={event.id} className="border rounded-lg p-6">
                          ...
                          <div className="flex space-x-3">
                            ...
                            {selectedItem === `event-${event.id}` ? (
                              ...
                              <Button
                                onClick={() =>
                                  setSelectedItem(`event-${event.id}`)
                                }
                                variant="destructive"
                              >
                                <XCircle className="w-4 h-4 mr-2" />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">
                      Comprehensive platform analytics and reporting will be
                      available here.
                    </p>
                  </div>
                </CardContent>
